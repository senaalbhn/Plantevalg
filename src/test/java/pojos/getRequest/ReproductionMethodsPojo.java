...
public class ReproductionMethodsPojo implements Serializable {
	private String id;
	...
	public ReproductionMethodsPojo() {
	}

	public ReproductionMethodsPojo(List<NamePojo> name) {
		this.name = name;
	}
