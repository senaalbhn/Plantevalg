...
public class NaturalLifespansPojo implements Serializable {
	private String id;
	...
	public NaturalLifespansPojo(List<NamePojo> name) {
		this.name = name;
	}

	public NaturalLifespansPojo() {
	}
