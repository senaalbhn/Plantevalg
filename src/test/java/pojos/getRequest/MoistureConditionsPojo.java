...
public class MoistureConditionsPojo implements Serializable {
	private String id;
	...
	public MoistureConditionsPojo() {
	}

	public MoistureConditionsPojo(List<NamePojo> name) {
		this.name = name;
	}
